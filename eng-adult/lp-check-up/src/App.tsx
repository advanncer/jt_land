        ...
        <div className="w-10">
          {step > 1 && (
            <button
              ...
              className="text-slate-300 hover:text-slate-900 transition-colors p-2 -ml-2"
            >
              <ArrowLeft size={24} />
            </button>
          )}
          ...
          >
            ...
            {currentStep?.type === "loader" && (
              <div className="text-center py-8 px-4 flex flex-col justify-center flex-1 h-full">
                ...
                <h2 className="text-2xl font-black mb-10 text-slate-900 leading-tight uppercase tracking-tight">
                  {currentStep.question || currentStep.title}
                </h2>
