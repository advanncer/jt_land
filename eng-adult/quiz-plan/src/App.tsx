  ...
  return (
    <div className="min-h-[100dvh] bg-violet-50 flex flex-col">
      ...
      >
          ...
          <div className="flex flex-col items-center text-center w-full">
            ...
            <div className="grid grid-cols-2 gap-3 w-full mb-8">
              {[
                ...
                >
                  <div className="text-xl font-black text-violet-950">{b.v}</div>
                  <div className="text-xs text-violet-400 font-semibold mt-0.5">{b.l}</div>
                </div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {s.stats?.map(stat => (
                <div
                  ...
                  className="bg-white rounded-2xl p-4 text-center border border-violet-100 shadow-sm"
                >
                  <div className="text-2xl font-black text-violet-950">{stat.value}</div>
        ...
        {s.type === 'word_test' && (
          <div className="w-full">
            <h2 className="text-2xl font-black text-violet-950 mb-2 text-center leading-tight">
              {s.question}
            </h2>
            <p className="text-sm text-violet-500 text-center mb-5 font-medium">
              {s.subtitle}
            </p>

            {/* Words grid */}
            <div className="bg-white rounded-3xl border border-violet-100 p-4 mb-4 shadow-sm">
                ...
                {WORDS.map(({ word }) => {
                  ...
                  return (
                    <button
                      ...
                      className={`py-2.5 px-2 rounded-xl text-sm font-bold transition-all border-2 active:scale-95 ${
                        checked
                          ? 'bg-violet-600 border-violet-600 text-white'
                          : 'bg-violet-50 border-violet-100 text-violet-700 hover:border-violet-400'
                      }`}
                    >
                      {word}
                    </button>
            ...
            <p className="text-center text-xs text-violet-400 font-medium mb-5">
              Вибрано:{' '}
              <strong className="text-violet-600">{checkedWords.size}</strong> із{' '}
              {WORDS.length} слів
            </p>
