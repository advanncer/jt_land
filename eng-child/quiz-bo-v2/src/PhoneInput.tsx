    ...
    <div className="relative" ref={wrapRef} style={{ fontFamily: 'var(--font-core)' }}>
      ...
      >
        ...
        <button
          ...
          className="flex items-center gap-1 pl-4 pr-3 py-4 shrink-0 border-r hover:bg-[var(--base-100)] transition-colors disabled:opacity-50 rounded-l-2xl cursor-pointer"
