    ...
    <>
      ...
      <ul className="text-gray-400 space-y-3 mb-6 mx-auto max-w-sm">
        <li className="flex items-center gap-3 bg-white/5 p-3 rounded-xl border border-white/10">
          ...
          <span>Ідеального репетитора під ваші потреби</span>
        </li>
        <li className="flex items-center gap-3 bg-white/5 p-3 rounded-xl border border-white/10">
          <span className="text-2xl">🎁</span>
          <span>Корисний PDF подарунок для дитини</span>
        </li>
      </ul>
    ...
    <>
      ...
      <div className="flex flex-col gap-4 mb-6">
        {[
          ...
          <div
            key={i}
            className="bg-white/5 border border-brand-orange/30 rounded-xl p-4 relative overflow-hidden"
          >
