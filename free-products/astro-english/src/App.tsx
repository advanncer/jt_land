              ...
              <div className="bg-white/5 p-6 md:p-12 rounded-[2.5rem] border border-white/10 mb-12 backdrop-blur-3xl shadow-2xl">
                <div className="grid grid-cols-2 gap-4 mb-10 text-left">
                  <div className="bg-white/5 p-4 rounded-2xl flex items-center gap-3 border border-white/5">
                    ...
                    <div><div className="text-[10px] opacity-40 uppercase">Управитель</div><div className="font-bold text-sm md:text-base">{selectedZodiac && ZODIAC_SIGNS.find(z=>z.id===selectedZodiac)?.ruler}</div></div>
                  </div>
                  <div className="bg-white/5 p-4 rounded-2xl flex items-center gap-3 border border-white/5">
                    <Flame className="text-orange-500" size={20}/> 
                    <div><div className="text-[10px] opacity-40 uppercase">Стихія</div><div className="font-bold text-sm md:text-base">{selectedZodiac && ZODIAC_SIGNS.find(z=>z.id===selectedZodiac)?.element}</div></div>
                  </div>
                </div>
